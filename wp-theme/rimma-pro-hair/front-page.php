...
/* Хелпери — читають page meta → дефолт */
function rc( $key ) {
    echo wp_kses( rimma_get( $key ), [ 'br' => [], 'strong' => [], 'em' => [] ] );
}
function ru( $key ) {
    echo esc_url( rimma_get( $key ) );
}
function ri( $key, $file ) { /* image src */
    echo esc_url( rimma_img_url( $key, $file ) );
}
?>
  ...
  <section class="hero">
    ...
    <div class="hero__bg">
      <img src="<?php ri('hero_bg','hero-bg.webp'); ?>" alt="" width="2178" height="1564">
    </div>

    <header class="header">
      <div class="header__left">
        <img class="header__logo" src="<?php ri('logo','logo.svg'); ?>" alt="Rimma" width="138" height="43">
      ...
      <button class="header__burger" aria-label="Меню">
        <svg width="32" height="14" viewBox="0 0 32 14" fill="none"><line x1="0" y1="0.75" x2="32" y2="0.75" stroke="white" stroke-width="1.5"/><line x1="0" y1="13.25" x2="32" y2="13.25" stroke="white" stroke-width="1.5"/></svg>
      </button>
    </header>

    <div class="hero__content">
      <h1 class="hero__title animation--fade-in"><?php rc('hero_title'); ?></h1>
      <p class="hero__desc animation--fade-in stagger-2"><?php rc('hero_desc'); ?></p>
  ...
  <div class="services-scroll-wrapper js-services-wrapper">
    ...
    <h2 class="services__title animation--fade-in"><?php rc('services_title'); ?></h2>
    ...
    <section class="services js-services" id="services">
      ...
      <div class="services__fan js-fan" role="region" aria-label="Послуги">
        ...
        <article class="service-card" data-index="<?php echo $n - 1; ?>">
          <img class="service-card__photo" src="<?php ri("service_{$n}_img","service-{$n}.webp"); ?>" alt="<?php echo esc_attr( rimma_get("service_{$n}_title") ); ?>">
  ...
  <section class="fears" id="fears">
    ...
    <h2 class="fears__title animation--fade-in"><?php rc('fears_title'); ?></h2>

    <div class="fears__media">
      <img class="fears__photo" src="<?php ri('fears_bg','fears-bg.webp'); ?>" alt="" width="1920" height="1260">

      <div class="fears__cards">
        <?php for ( $n = 1; $n <= 3; $n++ ) : ?>
        <article class="fear-card animation--fade-in stagger-<?php echo $n; ?>">
          <div class="fear-card__icon">
            <img src="<?php ri("fear_{$n}_icon","ic_card_{$n}.svg"); ?>" alt="" aria-hidden="true">
          </div>
  ...
  <section class="steps" id="steps">
    <div class="steps__inner">
      <div class="steps__left">
        <h2 class="steps__title animation--fade-in"><?php rc('steps_title'); ?></h2>
        <div class="steps__portrait">
          <video autoplay muted loop playsinline>
            <source src="<?php echo esc_url( get_template_directory_uri() . '/assets/video/steps-video.mp4' ); ?>" type="video/mp4">
          </video>
        </div>
      </div>
  ...
  <section class="about" id="about">
    ...
    <div class="about__top">
      <div class="about__photo animation--image-in">
        <img src="<?php ri('about_photo','about-photo.webp'); ?>" alt="<?php echo esc_attr( rimma_get('about_name') ); ?> — колорист та перукар">
      </div>
      ...
      <h2 class="about__title animation--fade-in"><?php rc('about_title'); ?></h2>
    ...
    <div class="about__cta" id="consultation">
      <h3 class="about__cta-title animation--fade-in"><?php rc('about_cta_title'); ?></h3>
      <a href="#booking" class="about__cta-btn animation--fade-in stagger-2"><?php rc('about_cta_btn'); ?></a>
    </div>
  </section>
  ...
  <section class="contact" id="booking">
    ...
    <div class="contact__map" aria-hidden="true">
      <img class="js-map-img" src="<?php ri('contact_map','contact-map.webp'); ?>" alt="" draggable="false">
    </div>

    <div class="contact__popup">
      <p class="contact__address"><?php rc('contact_address_popup'); ?></p>
      <a class="contact__map-link" href="<?php ru('contact_maps_url'); ?>" target="_blank" rel="noopener noreferrer">
        Дивитися на Google мапі
      </a>
    </div>

    <a class="contact__phone" href="tel:<?php rc('contact_phone_tel'); ?>"><?php rc('contact_phone_display'); ?></a>

    <div class="contact__actions">
      <a class="contact__btn" href="<?php ru('contact_telegram_url'); ?>" target="_blank" rel="noopener noreferrer" aria-label="Написати в Telegram">
      ...
      <a class="contact__btn" href="<?php echo esc_attr( rimma_get('contact_viber_url') ); ?>" target="_blank" rel="noopener noreferrer" aria-label="Написати у Viber">
        <svg class="contact__btn-icon" width="48" height="48" viewBox="0 0 48 48" fill="none" aria-hidden="true">
  ...
  <footer class="footer">
    <div class="footer__left">
      <div class="footer__logo">
        <img src="<?php ri('logo','logo.svg'); ?>" alt="Rimma" width="138" height="43">
      </div>
